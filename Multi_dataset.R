...
# res <- sum_single_effect_multi(X_1, Y_1, X_2, Y_2, L = 10)
# res1 <- which(abs(round(rowSums(res$b_mat_1), 4)) > 0)
# length(intersect(res1, index_c)) / p_c
# length(intersect(res1, index_1)) / p_1
...
# length(intersect(res2, index_c)) / p_c
# length(intersect(res2, index_2)) / p_2
